            ...
            <div class="row">
                    ...
                    <div class="text-center border-0 rounded card">
                        <div class="card-body">
                            <div class="p-3 shadow bg-soft-primary roundedd d-inline-block">
                                <img src="<?php echo e(asset('themes/purposeTheme/temp/images/icon/key.svg')); ?>"
                ...
                <div class="pt-2 mt-4 col-md-6 col-12">
                    <div class="text-center border-0 rounded card">
                        <div class="card-body">
                            <div class="p-3 shadow bg-soft-primary roundedd d-inline-block">
                                <img src="<?php echo e(asset('themes/purposeTheme/temp/images/icon/locked.svg')); ?>"
                                    class="avatar avatar-small" alt="">
                            </div>
                            <div class="mt-4">
                                <h5><a href="javascript:void(0)"
        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="pt-2 mt-4 text-center col-lg-4 col-md-4 col-12 text-md-right">
                    <img src="<?php echo e(asset('themes/purposeTheme/temp/images/app/phone.png')); ?>" class="img-fluid"
                        alt="">
                </div>
                <!--end col-->
            </div>
        ...
        <div class="container mt-100 mt-60 ">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <img src="<?php echo e(asset('themes/purposeTheme/temp/images/app/laptop.png')); ?>" class="img-fluid "
                        alt="">
                </div>
                <!--end col-->
                        ...
                        <?php $__currentLoopData = $test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimony): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="m-2 overflow-hidden border-0 card roundedd">
                                <div class="row align-items-center no-gutters">
                                    <div class="col-md-5">
                                        <img src="<?php echo e(asset('storage/' . $testimony->picture)); ?>" class="img-fluid w-75"
                                            alt="">
                                    </div>
                                    <!--end col-->
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\David\Documents\Personal\work\broker\resources\views/home/index.blade.php ENDPATH**/ ?>