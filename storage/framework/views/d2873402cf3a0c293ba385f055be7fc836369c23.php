...
} elseif ($_instance->childHasBeenRendered('kvYuZnb')) {
    $componentId = $_instance->getRenderedChildComponentId('kvYuZnb');
    $componentTag = $_instance->getRenderedChildComponentTagName('kvYuZnb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kvYuZnb');
} else {
    $response = \Livewire\Livewire::mount('user.investment-plan', []);
    $html = $response->html();
    $_instance->logRenderedChild('kvYuZnb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
