                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="contact-text">
                                                    <p>Call Us
                                                        :<span><?php echo e(formatPhoneNumber($settings->phone)); ?></span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="contact-thumb"><i class="fa fa-envelope-o"
                                                                              aria-hidden="true"></i></div>
                                                <div class="contact-text">
                                                    <p>Mail Us :<span><?php echo e($settings->contact_email); ?></span></p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
...
<?php echo $__env->make('snappy.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\David\Documents\Personal\work\broker\resources\views/snappy/contact.blade.php ENDPATH**/ ?>