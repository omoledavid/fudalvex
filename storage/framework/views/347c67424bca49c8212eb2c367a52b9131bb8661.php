                                ...
                                <?php if($title != 'Complete Payment'): ?>
                                    ...
                                    <div>
                                        <h6 class="">You are to make payment of
                                            <!-- <strong><?php echo e($settings->currency); ?><?php echo e(round($amount, 7)); ?></strong> -->
                                            <?php if($dtype == 'Bitcoin'): ?>
                                            <strong><?php echo e(round($btc, 7)); ?> BTC (<?php echo e($settings->currency); ?><?php echo e(number_format($amount)); ?>)</strong>
                                            <?php else: ?> <strong><?php echo e($settings->currency); ?><?php echo e(round($amount, 7)); ?></strong>
                                            <?php endif; ?>
                                            using
...
} elseif ($_instance->childHasBeenRendered('na3Tcmq')) {
    $componentId = $_instance->getRenderedChildComponentId('na3Tcmq');
    $componentTag = $_instance->getRenderedChildComponentTagName('na3Tcmq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('na3Tcmq');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('na3Tcmq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\David\Documents\Personal\work\broker\resources\views/purpose/user/payment.blade.php ENDPATH**/ ?>