                ...
                <div class="col-md-3 col-sm-6 pricing-list-botom-margin wow zoomIn" data-wow-duration="3s">
                    ...
                    <div class="pricing-list1">
                        <div class="pricing-header1">
                            ...
                            <p>Minimum return <?php echo e($plan->minr); ?> %</p>
                            <p>Maximum return <?php echo e($plan->maxr); ?> %</p>
                        </div>
                        <div class="price-range">
                            <div class="row">
                                <div class="col-md-6 text-left col-sm-6 col-xs-6">
                                    <div class="min-price">
                                        <h6>Minimum<span
                                                class="color-text"><?php echo e($settings->currency); ?><?php echo e($plan->min_price); ?> </span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="col-md-6 text-right col-sm-6 col-xs-6">
                                    <div class="min-price">
                                        <h6>Maximum<span
                                                class="color-text"><?php echo e($settings->currency); ?><?php echo e($plan->max_price); ?></span>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="price-range">
                            <div class="row">
                                <a style="width: 100%; white-space: normal;" href="<?php echo e(url('/login')); ?>"
...
<?php /**PATH C:\Users\David\Documents\Personal\work\broker\resources\views/snappy/sections/plans.blade.php ENDPATH**/ ?>