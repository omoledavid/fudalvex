                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="circle-item wow flipInY" data-wow-duration="2s">
                                            <img src="<?php echo e(asset('themes/snappyTheme/assets/images/crypto/bitcoin.jpg')); ?>" alt="items">
                                    ...
                                    <div class="col-md-3">
                                        <div class="circle-item wow flipInY" data-wow-duration="2s">
                                            <img src="<?php echo e(asset('themes/snappyTheme/assets/images/crypto/eth.jpg')); ?>" alt="items">
                                            <div class="circle-content">
                                    ...
                                    <div class="col-md-3">
                                        <div class="circle-item wow flipInY" data-wow-duration="2s">
                                            <img src="<?php echo e(asset('themes/snappyTheme/assets/images/crypto/litcoin.jpg')); ?>" alt="items">
                                            <div class="circle-content">
                                                <h6>LITE COIN</h6>
...
<?php /**PATH C:\Users\David\Documents\Personal\work\broker\resources\views/snappy/sections/paymentMethod.blade.php ENDPATH**/ ?>