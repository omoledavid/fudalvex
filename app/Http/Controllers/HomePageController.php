...
class HomePageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->activeTemplate().'.index')->with(array(
            'settings' => $settings,
    ...
    public function licensing()
    {
        ...
        return view($this->activeTemplate().'.licensing')
            ->with(array(
                'mplans' => Plans::where('type', 'Main')->get(),
                'pplans' => Plans::where('type', 'Promo')->get(),
    ...
    public function terms()
    {
        ...
        return view($this->activeTemplate().'.terms')
            ->with(array(
                'mplans' => Plans::where('type', 'Main')->get(),
    ...
    public function privacy()
    {
        ...
        return view($this->activeTemplate().'.privacy')
            ->with(array(
                'mplans' => Plans::where('type', 'Main')->get(),
    ...
    public function about()
    {
        ...
        return view($this->activeTemplate().'.about')
            ->with(array(
                'mplans' => Plans::where('type', 'Main')->get(),
    ...
    {
        return view($this->activeTemplate().'.contact')
            ->with(array(
                'mplans' => Plans::where('type', 'Main')->get(),
                'pplans' => Plans::where('type', 'Promo')->get(),
