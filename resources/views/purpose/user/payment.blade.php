                                ...
                                @if ($title != 'Complete Payment')
                                    ...
                                    <div>
                                        <h6 class="">You are to make payment of
                                            <!-- <strong>{{ $settings->currency }}{{ round($amount, 7) }}</strong> -->
                                            @if ($dtype == 'Bitcoin')
                                            <strong>{{ round($btc, 7) }} BTC ({{ $settings->currency }}{{ number_format($amount) }})</strong>
                                            @else <strong>{{ $settings->currency }}{{ round($amount, 7) }}</strong>
                                            @endif
                                            using
