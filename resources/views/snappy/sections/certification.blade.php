        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card" style="width: 100%; display: flex; flex-direction: row;">
                    <img class="card-img-left" data-toggle="modal" data-target="#cert" src="{{ asset('themes/snappyTheme/assets/images/certification.jpg')}}" alt="Card image cap" style="width: 50%; height: auto; object-fit: cover; margin-right: 1rem;">
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card" style="width: 100%; display: flex; flex-direction: row;">
                    <img class="card-img-left" data-toggle="modal" data-target="#letter" src="{{ asset('themes/snappyTheme/assets/images/letter.jpg')}}" alt="Card image cap" style="width: 50%; height: auto; object-fit: cover; margin-right: 1rem;">
                    <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="{{ asset('themes/snappyTheme/assets/images/certification.jpg')}}"/>
                    </div>
        ...
        <div class="modal fade" id="letter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="{{ asset('themes/snappyTheme/assets/images/letter.jpg')}}"/>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
